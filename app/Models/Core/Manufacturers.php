  ...
  public function __construct()
  {
    ...
    public function paginator(){
         $manufacturers =  Manufacturers::sortable(['manufacturers_id'=>'desc'])
                ...
                'manufacturers_info.date_last_click as clik_date','image_categories.path as path','manufacturers.seller_phone','manufacturers.seller_address')
                ->paginate(50);
    ...
    public function insert($request){
          ...
          $manufacturers_id = DB::table('manufacturers')->insertGetId([
              ...
              'seller_city_id'   =>   $request->seller_city_id,
          ...
          if ($manufacturers_id) {
            if (!empty($request->pincodes)) {
              foreach ($request->pincodes as $key => $value) {
                $manufacturers_pincodes = DB::table('manufacturers_pincodes')->insert([
                    'manufacturers_id' => $manufacturers_id,
                    'pincodes_id' => $value
                ]);
              }
    ...
    public function updaterecord($request){
                ...
                DB::table('manufacturers_pincodes')->where([
    ...
    public function destroyrecord($request){
        ...
        DB::table('manufacturers')->where('manufacturers_id', $request->manufacturers_id)->update([
            'is_delete' => 1
        ]);

        DB::table('manufacturers_pincodes')->where('manufacturers_id', $request->manufacturers_id)->update([
            'is_delete' => 1
        ]);
