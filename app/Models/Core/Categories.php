...
class Categories extends Model
{
    ...
    public function paginator(){
      ...
      $categories = Categories::sortable(['sort_order'=>'asc'])
           ->leftJoin('categories_description','categories_description.categories_id', '=', 'categories.categories_id')
    ...
    public function editsubcategory($request){
        $editSubCategory = DB::table('categories')
            ...
            'categories.categories_slug as slug', 'categories.categories_status  as categories_status', 'categories.parent_id as parent_id','categoryTable.path as imgpath','iconTable.path as iconpath', 'categories.cancelation_period', 'categories.return_period')
            ->where('categories.categories_id', $request->id)->get();
