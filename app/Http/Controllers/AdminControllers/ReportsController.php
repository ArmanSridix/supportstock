...
{
    public function __construct(Reports $reports, Setting $setting, Customers $customers,DeliveryBoys $DeliveryBoys, Products $products) {
    ...
    public function inventoryreport(Request $request)
    {
        ...
        $products = DB::table('products')
            ...
            ->select('products_description.products_name', 'products.products_id', 'products.products_model', 'products.products_sku')->orderBy('created_at','desc')->get();
    ...
    public function stockin(Request $request)
    {
        ...
        $title = array('pageTitle' => Lang::get("labels.ProductsStocks"));
        $result['reports'] = $this->reports->stockin($request);
        // echo "<pre>";
        // print_r($result['reports']);exit;
        $myVar = new SiteSettingController();
        $result['currency'] = $myVar->getSetting();
    ...
    {
        $title = array('pageTitle' => Lang::get("labels.Stockin"));
        $result['reports'] = $this->reports->stockin($request);
        ...
        return view("admin.reports.stockinprint", $title)->with('result', $result);
    }
