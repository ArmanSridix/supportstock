...
class OrdersController extends Controller
{
    ...
    public function display(Request $request)
    {
        ...
        $ordersData['orders'] = $this->Order->paginator($request);
        // echo "<pre>";print_r($ordersData['orders']);exit;
    ...
    public function updateCoustomerNotes(Request $request)
    {
        $coustomer_notes = $request->coustomer_notes;
        $orders_id = $request->orders_id;
        
        // if($coustomer_notes != ''){
                DB::table('orders')->where('orders_id', '=', $orders_id)
                ->where('customers_id', '!=', '')->update(['coustomer_notes' => $coustomer_notes]);
            // }
        return redirect()->back()->with('message', Lang::get("labels.CoustomerNotesUpdateMessage"));
    }
    ...
    public function invoiceprint(Request $request)
    {
        ...
        foreach ($order as $data) {
            ...
            $orders_products = DB::table('orders_products')
                ...
                ->select('orders_products.*', 'products.products_image as image','orders_status_reasons.status_reason')
        ...
        return view("admin.Orders.invoiceprint", $title)->with('data', $ordersData)->with('result', $result)->with('logoDetails', $logoDetails);
