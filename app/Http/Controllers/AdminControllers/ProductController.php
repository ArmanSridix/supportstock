...
class ProductController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $result['prev_product_id'] = DB::table('products')->select('products.products_id')->latest()->first();
        $result['commonContent'] = $this->Setting->commonContent();
        // dd($result);
    ...
    public function edit(Request $request)
    {
        ...
        $result['normal_price_list'] = DB::table('product_bulk_price')
            ->where('products_id','=',$request->id)
            ->where('user_type','=','Normal')->get();
        $result['corporate_price_list'] = DB::table('product_bulk_price')
            ->where('products_id','=',$request->id)
            ->where('user_type','=','Corporate')->get();
