<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> <?php echo e(trans('labels.pincode')); ?> <small><?php echo e(trans('labels.AddNewPincode')); ?>...</small> </h1>
            <ol class="breadcrumb">
                      ...
                      <div class="box-header">
                        ...
                        <?php endif; ?>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php echo Form::open(array('url' =>'admin/pincode/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.pincode')); ?><span style="color:red;">*</span>

                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('pincodes_val',  '', array('class'=>'form-control field-validate', 'id'=>'pincodes_val')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/admin/pincodes/add.blade.php ENDPATH**/ ?>