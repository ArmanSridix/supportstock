                ...
                <div class="col-xs-3">
                  <div class="form-group">
                    ...
                    <select type="button" required class="btn btn-default select2 form-control" data-toggle="dropdown" name="products_id" id="products_id"  >
                        ...
                        <option value="<?php echo e($product->products_id); ?>"  <?php if( app('request')->input('products_id')): ?> <?php if(app('request')->input('products_id') == $product->products_id): ?> <?php echo e('selected'); ?> <?php endif; ?> <?php endif; ?>><?php echo e($product->products_name); ?> ( <?php echo e($product->products_sku); ?> )</option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/reports/inventoryreport.blade.php ENDPATH**/ ?>