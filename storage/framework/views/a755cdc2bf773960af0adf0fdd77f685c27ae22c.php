            ...
            <tbody class="cart-table__body">
                ...
                <tr class="cart-table__row">
                    ...
                    <td class="cart-table__column cart-table__column--product">
                        <a href="<?php echo e(URL::to('/product-detail/'.$cart_products->products_id)); ?>" class="cart-table__product-name" target="_blank" ><?php echo e($cart_products->products_name); ?></a>
                        
                        <div class="item-attributes">
                            <?php if(isset($cart_products->attributes)): ?>
                                <?php $__currentLoopData = $cart_products->attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td class="cart-table__column cart-table__column--price" data-title="Total Price">
                        ₹<?php echo e($cart_products->final_price); ?>
                    ...
                    <td class="cart-table__column cart-table__column--price" data-title="Discount Price">
                        ...
                        ?>
                        ₹<?php echo e($cart_products->final_price-$discnt); ?>

                    </td>
                    <td class="cart-table__column cart-table__column--quantity" data-title="Quantity">
                        <div class="input-number">
                            <input class="form-control input-number__input" type="number" min="<?php echo e($cart_products->min_order); ?>" max="<?php echo e($cart_products->max_order); ?>" value="<?php echo e($cart_products->customers_basket_quantity); ?>" id="cart_quantity_<?php echo $cart_products->customers_basket_id; ?>" readonly/>
            ...
            <div class="form-group">
                <?php $__currentLoopData = session('coupon'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupons_show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="alert alert-success">
                        <a href="<?php echo e(URL::to('/removeCoupon/'.$coupons_show->coupans_id)); ?>" class="close" style="font-size: 36px;line-height: 23px;color: red;border: 1px solid red;" ><span aria-hidden="true">&times;</span></a>
                      <?php echo app('translator')->get('website.Coupon Applied'); ?> <?php echo e($coupons_show->code); ?>.<?php echo app('translator')->get('website.If you do not want to apply this coupon just click cross button of this alert.'); ?>
                    </div>
                        ...
                        <table class="cart__totals">
                            ...
                            <tbody class="cart__totals-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ₹<?php echo e(number_format((float)$coupon_amount, 2, '.', '')+0); ?>
                            ...
                            <tfoot class="cart__totals-footer">
                                <tr>
                                    <th>Total</th>
                                    <td>₹<?php echo e($withDiscTotal + number_format((float)$totalTax, 2, '.', '') + $shipping_price-number_format((float)$coupon_amount, 2, '.', '')); ?></td>
                                </tr>
                            </tfoot>
                        </table>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/web/viewcart.blade.php ENDPATH**/ ?>