                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php echo Form::open(array('url' =>'admin/insertFaq', 'method'=>'post', 'class' => 'form-horizontal form-validate' )); ?>


                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Title</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="faq_title" class="form-control field-validate" value="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <textarea id="editor1" name="faq_text" class="form-control"  rows="10" cols="80"></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/admin/faq/add.blade.php ENDPATH**/ ?>