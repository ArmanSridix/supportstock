                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <?php echo Form::text('products_sku', $result['product'][0]->products_sku, array('class'=>'form-control field-validate', 'id'=>'products_sku' , 'readonly'=>'readonly')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input name="cancelation_period" class="form-control number-validate" value="<?php echo e($result['product'][0]->cancelation_period); ?>" >
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input name="return_period" class="form-control number-validate" value="<?php echo e($result['product'][0]->return_period); ?>" >
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Please enter only numreic value.</span>
                                                        <span class="help-block hidden">Please enter only numreic value.</span>
                                                    </div>
                                                ...
                                                <div class="tabbable tabs-left">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane <?php if($j==0): ?> active <?php endif; ?>" id="product_<?=$description_data['languages_id']?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label">Quick Overview </label>
                                                                <div class="col-sm-10 col-md-8">
                                                                    <textarea id="pro_quick_overview<?=$description_data['languages_id']?>" name="pro_quick_overview_<?=$description_data['languages_id']?>" class="form-control"
                                                                      rows="5"><?php echo e(stripslashes($description_data['pro_quick_overview'])); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>