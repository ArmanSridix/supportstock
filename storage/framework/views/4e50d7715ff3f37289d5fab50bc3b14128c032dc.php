					...
					<div class="col-lg-3 col-md-4">
						<div class="left-side-tabs">
							<div class="dashboard-left-links">
                                ...
                                <a href="<?php echo e(URL::to('/corporateRequest')); ?>" class="user-item active"><i class="fa fa-cog"></i>Corporate Request</a>
								<?php } ?>
									...
									<div class="pdpt-bg">
										...
										<div class="address-body">
											...
											<?php if($user->user_type=='Normal'){ ?>
												...
												<?php }else{ ?>
													<a href="<?php echo e(URL::to('/updateCorporateRequest')); ?>" class="btn btn-secondary act-btn">Send Request</a>
												<?php } ?>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/web/corporate_request.blade.php ENDPATH**/ ?>