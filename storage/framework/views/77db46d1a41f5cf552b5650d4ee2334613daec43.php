                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input name="cancelation_period" class="form-control number-validate" value="<?php echo e($result['editSubCategory'][0]->cancelation_period); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input name="return_period" class="form-control number-validate" value="<?php echo e($result['editSubCategory'][0]->return_period); ?>">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                    Please enter only numreic value.</span>
                                                <span class="help-block hidden">Please enter only numreic value.</span>
                                            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>