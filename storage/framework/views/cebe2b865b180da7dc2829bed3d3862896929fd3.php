                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <!-- Modal -->
                                                        ...
                                                        <div id="imageselected">
                                                            <?php echo Form::button(trans('labels.Add Icon'), array('id'=>'newIcon','class'=>"btn btn-primary", 'data-toggle'=>"modal", 'data-target'=>"#Modalmanufactured" )); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <?php if(($result['languages'][0]->path!== null)): ?>
                                                        <img width="80px" src="<?php echo e(asset($result['languages'][0]->path)); ?>" class="">
                                                    <?php else: ?>
                                                        <img width="80px" src="<?php echo e(asset($result['languages'][0]->path)); ?>" class="">
                                                    <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\adminpanel\resources\views/admin/languages/edit.blade.php ENDPATH**/ ?>