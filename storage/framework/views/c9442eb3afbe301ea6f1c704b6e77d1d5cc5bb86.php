<?php $__env->startSection('content'); ?>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Phone Number<span style="color:red;">*</span></label>
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('seller_phone',  $editManufacturer->seller_phone, array('class'=>'form-control  number-validate', 'id'=>'seller_phone'), value(old('seller_phone'))); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Enter seller phone no.</span>
                                                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <textarea id="seller_address" name="seller_address" class="form-control  field-validate" rows="4" cols="50"><?php echo e($editManufacturer->seller_address); ?></textarea>
                                                    
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Enter seller full address.</span>
                                                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-2 control-label">City<span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-9">
                                                    <select class="form-control field-validate" name="seller_city_id" onChange="selectSellerPincode(this.value);">
                                                      ...
                                                      <option value="<?php echo e($cities->cities_id); ?>" <?php echo $editManufacturer->seller_city_id==$cities->cities_id?'selected':''; ?> ><?php echo e($cities->cities_name); ?></option>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                              ...
                                              <div class="col-xs-12">
                                                <div class="form-group">
                                                  <label for="name" class="col-sm-2 col-md-2 control-label">Pincode<span style="color:red;">*</span></label>
                                                  <div class="col-sm-10 col-md-9">
                                                    
                                                    <div id="seller_pincode_div">
                                                      <ul class="list-group list-group-root well">
                                                      </ul>
                                                    </div>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                        Choose at least one pincode.</span>
                                                    <span class="help-block hidden">Choose at least one pincode.</span>
                                                  </div>
                                                </div>
                                              </div>
                                          </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            <?php if(isset($result['manufacturureEdit'])){ ?>
              var cities_id = '<?php echo $editManufacturer->seller_city_id; ?>';
              var seller_id = '<?php echo $editManufacturer->id; ?>';
              ...
              if (cities_id!='') {
                $("#loader").show();
                  ...
                  $.ajax({
                    type:'POST',
                    url:'<?php echo e(url('admin/manufacturers/pincodeByCityEdit')); ?>',
                    data:{cities_id:cities_id,seller_id:seller_id},
                    success: function (data) {
                      //console.log(data);
                      $('#seller_pincode_div').html('');
                      $('#seller_pincode_div').html(data.html);
        ...
        function selectSellerPincode(cities_id){
            //alert(cities_id);
            if (cities_id!='') {
              $("#loader").show();
              ...
              $.ajax({
                type:'POST',
                url:'<?php echo e(url('admin/manufacturers/pincodeByCity')); ?>',
              ...
              $('#seller_pincode_div').html('<ul class="list-group list-group-root well"> </ul>');
            }
        }
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_7.4\htdocs\suportstock\resources\views/admin/manufacturers/edit.blade.php ENDPATH**/ ?>