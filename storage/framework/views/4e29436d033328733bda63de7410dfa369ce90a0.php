                    ...
                    <div class="item">
                       <div class="product">
                          <div class="product-header">
                             ...
                             <a href="<?php echo e(getproductdetailslink($today_deal_products->products_id)); ?>" target="_blank">
                          ...
                          <div class="product-footer">
                            ...
                            <a href="<?php echo e(getproductdetailslink($today_deal_products->products_id)); ?>" target="_blank" class="btn btn-secondary btn-sm float-right">View Detail</a>
                            <?php endif; ?>
                    ...
                    <div class="item">
                       <div class="product">
                          <div class="product-header">
                             ...
                             <a href="<?php echo e(getproductdetailslink($best_seller_products->products_id)); ?>" target="_blank">
                          ...
                          <div class="product-footer">
                            ...
                            <?php elseif($best_seller_products->products_type==1): ?>
                              <a href="<?php echo e(getproductdetailslink($best_seller_products->products_id)); ?>" target="_blank" class="btn btn-secondary btn-sm float-right">View Detail</a>
                            <?php endif; ?>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7432\htdocs\suportstock\resources\views/web/index.blade.php ENDPATH**/ ?>