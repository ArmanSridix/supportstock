                            ...
                            <?php echo Form::open(array('url' =>'admin/updateSlide', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control field-validate" name="carousel_id">
                                         <option value="1" <?php if($result['sliders']->carousel_id == 1): ?> selected <?php endif; ?> ><?php echo app('translator')->get('labels.Full Screen Slider (1263x363)'); ?></option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group categoryContent">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control field-validate category-type select2" name="categories_id" id="categories_id" style="width: 100 %">
                                      <?php $__currentLoopData = $result['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                		<option value="<?php echo e($category->id); ?>" <?php if($result['sliders']->type=='category'){if($result['sliders']->sliders_url==$category->id){echo "selected";}} ?>><?php echo e($category->name); ?></option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group productContent" style="display: none">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      ...
                                      <?php $__currentLoopData = $result['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                		    <option value="<?php echo e($products_data->products_id); ?>" <?php if($result['sliders']->type=='product'){if($result['sliders']->sliders_url==$products_data->products_id){echo "selected";}} ?>><?php echo e($products_data->products_name. '(' . $products_data->products_sku . ')'); ?></option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7432\htdocs\suportstock\resources\views/admin/settings/web/sliders/edit.blade.php ENDPATH**/ ?>