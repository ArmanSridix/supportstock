                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    <br>
                                      <?php if($errors->has('adds_position')): ?>
                                        <?php if($errors->first('adds_position') == 'left'): ?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php echo Form::open(array('url' =>'admin/categories/updateAdds', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>


                                        <?php echo Form::hidden('categories_id', $result['categories_id'] , array('class'=>'form-control', 'id'=>'id')); ?>

                                        <?php echo Form::hidden('adds_position', 'left' , array('class'=>'form-control', 'id'=>'adds_position')); ?>
                                    ...
                                    <div class="left_link_div">
                                        ...
                                        <?php echo Form::hidden('oldImage', $old_image , array('id'=>'oldImage', 'class'=>'')); ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    <br>
                                      <?php if($errors->has('adds_position')): ?>
                                        <?php if($errors->first('adds_position') == 'top'): ?>
                                      <div class="alert alert-success alert-dismissible" role="alert">
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                          <?php echo e($errors->first('message')); ?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php echo Form::open(array('url' =>'admin/categories/updateAdds', 'method'=>'post', 'class' => 'form-horizontal form-validate2', 'enctype'=>'multipart/form-data')); ?>


                                        <?php echo Form::hidden('categories_id', $result['categories_id'] , array('class'=>'form-control', 'id'=>'id')); ?>

                                        <?php echo Form::hidden('adds_position', 'top' , array('class'=>'form-control', 'id'=>'adds_position')); ?>
                                    ...
                                    <div class="top_link_div">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                ...
                                                <div class="modal fade" id="Modalmanufactured2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                  ...
                                                  <?php echo Form::button(trans('labels.Add Image'), array('id'=>'newImage2','class'=>"btn btn-primary ", 'data-toggle'=>"modal", 'data-target'=>"#Modalmanufactured2" )); ?>
                                        ...
                                        <?php echo Form::hidden('oldImage', $old_image2 , array('id'=>'oldImage', 'class'=>' ')); ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    <br>
                                      <?php if($errors->has('adds_position')): ?>
                                        <?php if($errors->first('adds_position') == 'bottom'): ?>
                                      <div class="alert alert-success alert-dismissible" role="alert">
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                          <?php echo e($errors->first('message')); ?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php echo Form::open(array('url' =>'admin/categories/updateAdds', 'method'=>'post', 'class' => 'form-horizontal form-validate3', 'enctype'=>'multipart/form-data')); ?>


                                        <?php echo Form::hidden('categories_id', $result['categories_id'] , array('class'=>'form-control', 'id'=>'id')); ?>

                                        <?php echo Form::hidden('adds_position', 'bottom' , array('class'=>'form-control', 'id'=>'adds_position')); ?>
                                    ...
                                    <div class="bottom_link_div">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                ...
                                                <div class="modal fade" id="Modalmanufactured3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                  ...
                                                  <?php echo Form::button(trans('labels.Add Image'), array('id'=>'newImage3','class'=>"btn btn-primary ", 'data-toggle'=>"modal", 'data-target'=>"#Modalmanufactured3" )); ?>
                                        ...
                                        <?php echo Form::hidden('oldImage', $old_image3 , array('id'=>'oldImage', 'class'=>' ')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/categories/adds_edit.blade.php ENDPATH**/ ?>