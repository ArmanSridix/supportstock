...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Update Shipping <small>Update Shipping...</small> </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Update Shipping </h3>
                    </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-8">
                                              <textarea id="editor1" name="cms_text" class="form-control"
                                                rows="5"><?php echo e(stripslashes($shippingDetails->cms_text)); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/cms/shipping.blade.php ENDPATH**/ ?>