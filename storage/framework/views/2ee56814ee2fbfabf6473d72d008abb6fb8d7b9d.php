                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <select class="form-control field-validate product-type select2" id="products_list" name="products_id">
                                                ...
                                                <option value="<?php echo e($pro->products_id); ?>"><?php echo e($pro->products_name . '(' . $pro->products_sku . ')'); ?></option>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-info">
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-4 control-label"><?php echo e(trans('labels.stocktype')); ?> </label>
                                                                    <div class="col-sm-10 col-md-8">
                                                                    <select class="form-control" name="stock_type">
                                                                            <option value="in"><?php echo e(trans('labels.in')); ?></option>
                                                                            <option value="out"><?php echo e(trans('labels.out')); ?></option>
                                                                        </select>
                                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                            <?php echo e(trans('labels.stocktypetext')); ?></span>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name" class="col-sm-2 col-md-4 control-label"><?php echo e(trans('labels.Reference')); ?></label>
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <input type="text" name="reference_code" value="" class="form-control">
                                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                            <?php echo e(trans('labels.Reference Text')); ?></span>
                                                                    </div>
                                                                </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/products/inventory/add1.blade.php ENDPATH**/ ?>