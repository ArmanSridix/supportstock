                                    ...
                                    <form name='registration' id="registration" class="registration" method="get" action="<?php echo e(url('admin/customers/filter')); ?>">
                                        ...
                                        <div class="input-group-form search-panel ">
                                            <select type="button" class="btn btn-default dropdown-toggle form-control" data-toggle="dropdown" name="FilterBy" id="FilterBy">
                                                ...
                                                <option value="Status" <?php if(isset($filter)): ?> <?php if($filter=="Status" ): ?> <?php echo e('selected'); ?><?php endif; ?> <?php endif; ?>><?php echo e(trans('labels.Status')); ?></option>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo e($listingCustomers->cities_name); ?>,
                                                <?php endif; ?>
                                                ...
                                                <?php echo e($listingCustomers->pincodes_val); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <strong class="badge bg-light-grey">inactive</strong>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                ...
                                                <a data-toggle="tooltip" data-placement="bottom" title="<?php echo e($listingCustomers->first_name); ?> <?php echo e($listingCustomers->last_name); ?>" href="<?php echo e(url('admin/customers/viewKyc')); ?>/<?php echo e($listingCustomers->id); ?>" class="badge bg-light-blue">KYC</a>
                                                <?php } ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7432\htdocs\suportstock\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>