                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php echo Form::open(array('url' =>'admin/updateInvoiceLogo', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>

                                        
                                        <?php echo Form::hidden('oldIcon', $logoDetails[0]->invoice_logo_image , array('id'=>'oldIcon')); ?>



                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Invoice Logo</label>
                                            <div class="col-sm-10 col-md-4">
                                                ...
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Upload invoice logo.</span>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/logo_invoice.blade.php ENDPATH**/ ?>