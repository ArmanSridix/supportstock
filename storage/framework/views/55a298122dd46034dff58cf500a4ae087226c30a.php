...
<div class="content-wrapper">
  ...
  <section class="invoice" style="margin: 15px;">
      ...
      <div class="row">
        ...
        <?php echo Form::open(array('url' =>'admin/orders/updateCoustomerNotes', 'method'=>'post', 'class' => 'form-horizontal',)); ?>

        <?php echo Form::hidden('orders_id', $data['orders_data'][0]->orders_id, array('class'=>'form-control', 'id'=>'orders_id')); ?>

            <div class="col-xs-12">
              <hr>
                <p class="lead"><?php echo e(trans('labels.CoustomerNotes')); ?>:</p>
                  <div class="col-md-12">
                    <div class="form-group">
                      <?php echo Form::textarea('coustomer_notes', stripslashes($data['orders_data'][0]->coustomer_notes), array('class'=>'form-control', 'id'=>'coustomer_notes', 'rows'=>'4')); ?>
     ...
     <?php echo Form::hidden('customers_id', $data['orders_data'][0]->customers_id, array('class'=>'form-control', 'id'=>'device_id')); ?>
        ...
        <hr>
          <p class="lead"><?php echo e(trans('labels.ChangeStatus')); ?>:</p>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label><?php echo e(trans('labels.OrderStatus')); ?>:</label>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/Orders/vieworder.blade.php ENDPATH**/ ?>