                                ...
                                <form  name='registration' id="registration2" class="registration" method="get">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        <select id="FilterBy" type="button" class="btn btn-default dropdown-toggle form-control input-group-form " data-toggle="dropdown" name="categories_id">
                                            ...
                                            <option value="" selected disabled hidden><?php echo e(trans('labels.ChooseCategory')); ?>/<?php echo e(trans('labels.sku')); ?></option>
                                            <option value="Active"
                                                <?php if(isset($_REQUEST['categories_id']) and !empty($_REQUEST['categories_id'])): ?>
                                                    <?php if( $_REQUEST['categories_id'] == 'Active'): ?>
                                                        selected
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            >Active</option>
                                            <option value="Inactive"
                                                <?php if(isset($_REQUEST['categories_id']) and !empty($_REQUEST['categories_id'])): ?>
                                                    <?php if( $_REQUEST['categories_id'] == 'Inactive'): ?>
                                                        selected
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            >Inactive</option>
                                            ...
                                            <option value="sku"
                                                <?php if(isset($_REQUEST['categories_id']) and !empty($_REQUEST['categories_id'])): ?>
                                                    <?php if( $_REQUEST['categories_id'] == 'sku'): ?>
                                                        selected
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            ><?php echo e(trans('labels.sku')); ?></option>
                                        ...
                                        <?php if(isset($categories_id)): ?>  <a class="btn btn-danger " href="<?php echo e(url('admin/products/display')); ?>"><i class="fa fa-ban" aria-hidden="true"></i> </a><?php endif; ?>
                                    </div>
                                </form>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo e(trans('labels.sku')); ?></th>
                                        ...
                                        <?php if(count($results['products'])>0): ?>
                                            ...
                                            <?php $__currentLoopData = $resultsProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($product->products_sku); ?></td>
                                                    <td>
                                ...
                                <div class="col-xs-12 col-md-6 text-right">
                                    ...
                                    <?php echo e($results['products']->appends(\Request::except('type'))->render()); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/products/index.blade.php ENDPATH**/ ?>