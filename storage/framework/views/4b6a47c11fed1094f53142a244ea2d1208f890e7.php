...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Edit Shipping rate <small><?php echo e(trans('labels.Setting')); ?>...</small> </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        <!-- form start -->
                                        <div class="box-body">
                                        <?php echo Form::open(array('url' =>'admin/shippingmethods/update', 'method'=>'post', 'id'=>'shippingmethodsupdate', 'class' => 'form-horizontal form-validate' )); ?>


                                        <input type="hidden" name="id" class="form-control field-validate" value="<?php echo e($shipping_rate->id); ?>">
                                            
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Amount (From)</label>
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="amount_from" id="amount_from" class="form-control field-validate" value="<?php echo e($shipping_rate->amount_from); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-8">
                                                    <input type="text" name="amount_to" id="amount_to" class="form-control field-validate" value="<?php echo e($shipping_rate->amount_to); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="shipping_rate" class="form-control field-validate" value="<?php echo e($shipping_rate->shipping_rate); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/shippingmethods/edit.blade.php ENDPATH**/ ?>