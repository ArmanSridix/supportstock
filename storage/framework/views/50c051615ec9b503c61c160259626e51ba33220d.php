   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12 text-center">
            ...
            20% cashback for new users | Code: <strong><span class="text-light">SSOFERS13 <span class="mdi mdi-tag-faces"></span></span> </strong>
            </a>
         </div>
      </div>
   </div>
...
<nav class="navbar navbar-light navbar-expand-lg bg-dark bg-faded osahan-menu">
   <div class="container-fluid">
      ...
      <a class="location-top d-flex align-items-center" href="#">
      <i class="mdi mdi-map-marker-circle" aria-hidden="true"></i>
      <span class="delivery"> <span class="pincode"> 600033 <i class='mdi mdi-chevron-down' style="font-size: 18px;"></i></span></span>
      </a>
...
<div id="mobile-menu">
   <ul>
      ...
      <li>
         <a href="<?php echo e(URL::to('/shop')); ?>" >WholeSale Deals</a>
         <ul>
            <li>
               <a href="<?php echo e(URL::to('/shop')); ?>" ><span>AirConditioner & Refrigeration Spares</span></a>
               <ul>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>A.C Spares</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Refrigerator Spares</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Washing Machine Spares</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>A.C Spares</span></a></li>
               </ul>
            </li>
            <li>
               <a href="<?php echo e(URL::to('/shop')); ?>" ><span>Mobile and Computers</span></a>
               <ul>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Headphones</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Mobile Battery</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Headphones</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Mobile Battery</span></a></li>
               </ul>
            </li>
            <li>
               <a href="<?php echo e(URL::to('/shop')); ?>" ><span>Home and kichen Appliances</span></a>
               <ul>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Floor Mat</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Dinning</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Floor Mat</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Dinning</span></a></li>
               </ul>
            </li>
            <li>
               <a href="<?php echo e(URL::to('/shop')); ?>" ><span>Grocery</span></a>
               <ul>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Turmeric Powder</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Healthy Dry Fruits</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Spices & Masala</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Turmeric Powder</span></a></li>
               </ul>
            </li>
            <li>
               <a href="<?php echo e(URL::to('/shop')); ?>" ><span>Kids Toys & Fashion</span></a>
               <ul>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Dolls</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Board Games</span></a></li>
               </ul>
            </li>
            <li>
               <a href="<?php echo e(URL::to('/shop')); ?>" ><span>Mens Fashion</span></a>
               <ul>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Formal Wear</span></a></li>
                  <li><a href="<?php echo e(URL::to('/shop')); ?>" ><span>Casual Wear</span></a></li>
               </ul>
            </li>
         </ul>
      </li>
                        ...
                        <div class="login-modal-right">
                           <div class="tab-content">
                              ...
                              <div  id="login">
                                 ...
                                 <form action = "<?php echo e(url('sellOnSupportstock')); ?>" method = "POST">
                                    <?php echo csrf_field(); ?>
                                    <fieldset class="form-group">
                                       <label>Name*</label>
                                    ...
                                    <fieldset class="form-group">
                                       <label>Email*</label>
                                       <input type="text" class="form-control" name="sEmail" placeholder="Enter your email-id" required>
                                    </fieldset>
                                    <fieldset class="form-group">
                                       <label>Phone*</label>
                                       <input type="text" class="form-control" name="sPhone" placeholder="Enter your phone no" required>
                                    </fieldset>
                                    <fieldset class="form-group">
                                       <label>Feedback*</label>
                                       <textarea id="" class="form-control" name="sFeedback" rows="4" cols="50" placeholder="Enter your feedback" required></textarea>
                                    </fieldset>
                              ...
                              <div  id="register">
                                 ...
                                 <form action = "<?php echo e(url('signupBefore')); ?>" method = "POST">
                                    ...
                                    <fieldset class="form-group">
                                       ...
                                       <input type="text" name="phone" class="form-control" placeholder="+91 123 456 7890" required>
                                    </fieldset>
                                    <fieldset class="form-group">
...
</script><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/web/common/header.blade.php ENDPATH**/ ?>