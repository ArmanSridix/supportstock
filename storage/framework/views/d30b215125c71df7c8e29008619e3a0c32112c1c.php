                            ...
                            <div class="form-dt">
                                ...
                                <?php if($returnData['order_status'] == 'success'){ ?>
                                    <div>
                                        ...
                                        <a href="<?php echo e(url('orders')); ?>" class="next-btn16 hover-btn" >Ok</a>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if($returnData['order_status'] == 'fail'){ ?>
                                    <div>
                                        ...
                                        <a href="<?php echo e(url('checkout')); ?>" class="next-btn16 hover-btn" >Ok</a>
                                    </div>
                                <?php } ?>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/web/paymentSuccess.blade.php ENDPATH**/ ?>