...
<div style="padding: 5px;">
  ...
  <div style="width: 100%; display: block;text-align: center;">
    <?php if(!empty($ordersData['logoDetails'])){ ?>
      <img src="<?php echo e(asset($ordersData['logoDetails'][0]->iconpath)); ?>" alt="logo">
    <?php } ?>
  </div>
...
<?php /**PATH /home/supportmain/webapps/supportstock/resources/views//mail/orderEmail.blade.php ENDPATH**/ ?>