<?php $__env->startSection('content'); ?>
                                        ...
                                        <?php if(count($data['customer_addresses']) > 0): ?>
                                            <?php $__currentLoopData = $data['customer_addresses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer_addresses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($customer_addresses->entry_company!=''){ ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <strong><?php echo e(trans('labels.Postcode')); ?>:</strong> <?php echo e($customer_addresses->pincodes_val); ?><br>
                                                        <strong><?php echo e(trans('labels.City')); ?>:</strong> <?php echo e($customer_addresses->cities_name); ?><br>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-8">
                                                <select id="entry_city" class="form-control field-validate" name="entry_city">
                                                    ...
                                                    <?php $__currentLoopData = $data['cities']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($city_data->cities_id); ?>"><?php echo e($city_data->cities_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-8">
                                                <select id="entry_postcode" class="form-control field-validate" name="entry_postcode">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#entry_city").change(function(){
                var entry_city = $("#entry_city").val();  
                if(entry_city==''){
                    $('#entry_postcode').val('');
                    $('#entry_postcode').html('');
                    $('#entry_postcode').append( $('<option></option>').val("").html("Select Postcode") );
                }else{
                    $('#entry_postcode').val('');
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            $.each(data.pincode_list, function(val, text) {
                                $('#entry_postcode').append( $('<option></option>').val(text.pincodes_id).html(text.pincodes_val) )
                            });
                        }
                    });
                }
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/admin/customers/address/index.blade.php ENDPATH**/ ?>