            ...
            <tbody class="cart-table__body">
                ...
                <tr class="cart-table__row" id="wishlist_<?php echo $product_data->products_id; ?>">
                    <td class="cart-table__column cart-table__column--image">
                        <a href="#"><img src="<?php echo e(asset('').$product_data->image_path); ?>" alt=""></a>
                    </td>
                    ...
                    <td class="cart-table__column cart-table__column--total" data-title="Total"><a href="javascript:void(0);" class="btn btn-secondary addu-button">Add to Cart</a></td>
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/web/wishlist.blade.php ENDPATH**/ ?>