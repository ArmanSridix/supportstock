                             ...
                             <div  >
                                <h5 class="heading-design-h5">Please select your location</h5>
                                   ...
                                   <select class="form-control" name="" id="webb_citiess" >
                                         ...
                                         <option selected value="<?php echo e($city->cities_id); ?>"><?php echo e($city->cities_name); ?></option>
                                   ...
                                   <select class="form-control mt-2 mSelectDropdown"  name="" id="webb_pincodes" >
                                    ...
                                    <?php $__currentLoopData = $pincodesVal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pincodesValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    
                                       <option value="<?php echo e($pincodesValue->pincodes_id); ?>"><?php echo e($pincodesValue->pincodes_val); ?></option>
        ...
        <div class="row">
           ...
           <div class="col-md-6 col-lg-6 col-xl-5 p-1">
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <div class="review">
                    ...
                    <div class="user-review">
                      <P style="font-weight: bolder"><?php echo e($result['averageRating']); ?> out of 5 stars.</P>
              ...
              <?php } ?>
                ...
                <div class="sharethis-inline-share-buttons" data-title="<?php echo e($result['detail']['product_data'][0]->products_name); ?>" data-image="<?php echo e(asset('').$result['detail']['product_data'][0]->image_path); ?>"></div>
                <!-- ShareThis END -->
                ...
                <div class="item">
                   <div class="product">
                      <div class="product-header">
                         ...
                         <a href="<?php echo e(getproductdetailslink($recentProducts->products_id)); ?>" target="_blank">
                      ...
                      <div class="product-footer">
                        ...
                        <a href="<?php echo e(URL::to(preg_replace('/[^a-zA-Z0-9]+/', '-', preg_replace('/\s+/', ' ', $recentProducts->products_name)) . '-' . $recentProducts->products_id)); ?>" target="_blank" class="btn btn-secondary btn-sm float-right">View Detail</a>
                        <?php endif; ?>
                ...
                <div class="item">
                   <div class="product">
                      <div class="product-header">
                         ...
                         <a href="<?php echo e(getproductdetailslink($simliar_trending_products->products_id)); ?>
                      ...
                      <div class="product-body">
                         <a href="<?php echo e(getproductdetailslink($simliar_trending_products->products_id)); ?>" target="_blank">
                      ...
                      <div class="product-footer">
                        ...
                        <a href="<?php echo e(getproductdetailslink($simliar_trending_products->products_id)); ?>" target="_blank" class="btn btn-secondary btn-sm float-right">View Detail</a>
                        <?php endif; ?>
  ...
  function cityyCheck(){
    ...
    if (cities_id=='') {
      ...
      $.ajax({
        ...
        type:'POST',
        url:'<?php echo e(url('checkPincodeExist')); ?>',
        data:{pincodes_id:pincodes_id,"_token": "<?php echo e(csrf_token()); ?>"},
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7432\htdocs\suportstock\resources\views/web/detail.blade.php ENDPATH**/ ?>