...
<script>
  $(document).on('click', '#deleteCustomerFrom', function() {
    ...
    $.ajax({
        url: "<?php echo e(route('deleteadmin')); ?>", // URL to your Laravel route
        type: 'POST',
        data: {
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_7.4\htdocs\suportstock\resources\views/admin/admins/index.blade.php ENDPATH**/ ?>