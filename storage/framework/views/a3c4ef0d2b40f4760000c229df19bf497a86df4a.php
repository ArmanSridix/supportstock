                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('seller_phone',  '', array('class'=>'form-control  number-validate', 'id'=>'seller_phone'), value(old('seller_phone'))); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <textarea id="seller_address" name="seller_address" class="form-control  field-validate" rows="4" cols="50"></textarea>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-9">
                                                    <select class="form-control field-validate" name="seller_city_id" onChange="selectSellerPincode(this.value);">
                                                      ...
                                                      <option value="<?php echo e($cities->cities_id); ?>"><?php echo e($cities->cities_name); ?></option>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                        Choose City
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/manufacturers/add.blade.php ENDPATH**/ ?>