                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                            ...
                            <h3 class="box-title"><?php echo e(trans('labels.EditCoupons')); ?></h3>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">User Restrictions</label>
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="email_restrictions[]" multiple class="form-control select2">
                                                        <?php $__currentLoopData = $result['emails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($emails->email); ?>"  <?php if(in_array($emails->email, explode(',', $result['coupon'][0]->email_restrictions))): ?> selected <?php endif; ?> ><?php echo e($emails->first_name); ?> <?php echo e($emails->last_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">List of user that can use this coupon.</span>
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/admin/coupons/edit.blade.php ENDPATH**/ ?>