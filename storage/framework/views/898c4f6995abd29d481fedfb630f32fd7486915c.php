...
<script src="<?php echo e(asset('frontEnd/mSelect/chosen.jquery.min.js')); ?>"></script>
...
<script type="text/javascript">
  ...
  function pincodeByCity(){
    ...
    $.ajax({
      ...
      type:'POST',
      url:'<?php echo e(url('pincodesByCity')); ?>',
      data:{cities_id:cities_id,"_token": "<?php echo e(csrf_token()); ?>"},
      success:function(data){
...
<?php /**PATH /home/supportmain/webapps/supportstock/resources/views/web/common/scripts.blade.php ENDPATH**/ ?>