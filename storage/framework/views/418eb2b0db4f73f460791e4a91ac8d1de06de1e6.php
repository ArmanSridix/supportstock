...
<section class="pt-2 pb-2 page-info section-padding border-bottom bg-white">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <a href="<?php echo e(URL::to('/')); ?>"><strong><span class="mdi mdi-home"></span> Home</strong></a>   <span class="mdi mdi-chevron-right"></span><a href="javascript:;"> Contact Us </a>
               </div>
            </div>
         </div>
      </section>
...
<div class="col-lg-8 col-md-8">
	...
	<form action="<?php echo e(URL::to('/contactUsMail')); ?>" method="post" class="form-validate" id="contact_form">
		<?php echo csrf_field(); ?>
		      ...
		      if(this.value == '' || this.value.length < 10 || isNaN(this.value)) {
		   	...
		   	if(error=="has error"){
		    	...
		    	$.ajax({
                  	...
                  	type:'POST',
                  	url:'<?php echo e(url('contactOtpSend')); ?>',
                  	data:{"_token": "<?php echo e(csrf_token()); ?>",contact_name:contact_name,contact_phone:contact_phone,contact_mail:contact_mail},
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/supportmain/webapps/supportstock/resources/views/web/contact_us.blade.php ENDPATH**/ ?>