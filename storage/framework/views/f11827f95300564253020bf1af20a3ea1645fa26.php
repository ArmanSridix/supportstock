...
$(document).on('click', '#updateAddress', function(e){
	...
	//deleteReasonOfCancelOrderModal
	$(document).on('click', '#deleteReasonOfCancelOrder', function(){
		var reason_id = $(this).attr('reason_id');
		$('#reason_id').val(reason_id );
		$("#deleteReasonOfCancelOrderModal").modal('show');
	});

	//deleteReasonOfReturnOrderModal
	$(document).on('click', '#deleteReasonOfReturnOrder', function(){
		var reason_id = $(this).attr('reason_id');
		$('#reason_id').val(reason_id );
		$("#deleteReasonOfReturnOrderModal").modal('show');
	});
  ...
  $(document).on('click', '#delete', function(){
	...
	//deleteFaqModal
	$(document).on('click', '#deletefaqId', function(){
...
$(document).on('submit', '.form-validate2', function(e){
	...
	$(".number-validate2").each(function() {
		if(this.value == '' || isNaN(this.value)) {
			$(this).closest(".form-group").addClass('has-error');
			//$(this).next(".error-content").removeClass('hidden');
			error = "has error";
...
//focus form field
$(document).on('keyup change', '.field-validate2', function(e){
...
$(document).on('click', '.required_one2', function(e){
...
//focus form field
$(document).on('keyup', '.number-validate2', function(e){
...
//focus form field
$(document).on('keyup', '.price-validate2', function(e){
...
//focus form field
$(document).on('keyup', '.stock-validate2', function(e){
	//var re = /^[-+]?[0-9]+\.[0-9]+$/;
	// /this.value.match( re )
	var x = event.keyCode;
	// if(this.value == '' || isNaN(this.value) || this.value > 0) {
...
$(document).on('keyup focusout', '.email-validate2', function(e){
	var validEmail = /^[A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
	if(this.value != '' && validEmail.test(this.value)) {
		$(this).closest(".form-group").removeClass('has-error');
		//$(this).next(".error-content").addClass('hidden');
...
$(document).on('submit', '.form-validate3', function(e){
	...
	$(".number-validate3").each(function() {
		if(this.value == '' || isNaN(this.value)) {
			$(this).closest(".form-group").addClass('has-error');
			//$(this).next(".error-content").removeClass('hidden');
			error = "has error";
...
//focus form field
$(document).on('keyup change', '.field-validate3', function(e){
...
$(document).on('click', '.required_one3', function(e){
...
//focus form field
$(document).on('keyup', '.number-validate3', function(e){
...
//focus form field
$(document).on('keyup', '.price-validate3', function(e){
...
//focus form field
$(document).on('keyup', '.stock-validate3', function(e){
	//var re = /^[-+]?[0-9]+\.[0-9]+$/;
	// /this.value.match( re )
	var x = event.keyCode;
	// if(this.value == '' || isNaN(this.value) || this.value > 0) {
...
$(document).on('keyup focusout', '.email-validate3', function(e){
	var validEmail = /^[A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
	if(this.value != '' && validEmail.test(this.value)) {
		$(this).closest(".form-group").removeClass('has-error');
		//$(this).next(".error-content").addClass('hidden');
...
$( "#registration2" ).on('click','#submit',function( event ) {
...
$(document).on('click','#selected2', function(){
    var image_src = $('.thumbnail.selected').children('img').attr('src');
	if(image_src != undefined){
		$('#selectedthumbnail2').html('<img src="'+image_src+'" class = "thumbnail" style="max-height: 100px; margin-top: 20px;">');
		$('#selectedthumbnail2').show();
		$('#image-close2').show();
		$('#imageselected').removeClass('has-error');
		$('#newImage2').removeClass('field-validate');
		$('.thumbnail.selected').removeClass('selected');
	}
});
$(document).on('click','#image-close2', function(){
   $("select.show-html:not(#countertop_countertype_id)").val('').imagepicker({
    ...
    $('#selectedthumbnail2').hide();
    $('#image-close2').hide();
    $('#imageselected').removeClass('has-error');
});
$(document).on('click','#selected3', function(){
    var image_src = $('.thumbnail.selected').children('img').attr('src');
	if(image_src != undefined){
		$('#selectedthumbnail3').html('<img src="'+image_src+'" class = "thumbnail" style="max-height: 100px; margin-top: 20px;">');
		$('#selectedthumbnail3').show();
		$('#image-close3').show();
		$('#imageselected').removeClass('has-error');
		$('#newImage3').removeClass('field-validate');
		$('.thumbnail.selected').removeClass('selected');
	}
});
$(document).on('click','#image-close3', function(){
   $("select.show-html:not(#countertop_countertype_id)").val('').imagepicker({
        // show_label:   true,
        clicked:function(){
            $(this).find("option[value='" + $(this).val() + "']").empty();
...
<?php /**PATH /home/supportmain/webapps/supportstock/resources/views/admin/common/scripts.blade.php ENDPATH**/ ?>