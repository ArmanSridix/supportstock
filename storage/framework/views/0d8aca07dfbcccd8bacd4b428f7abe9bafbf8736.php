                                        ...
                                        <?php if(count($manufacturers)>0): ?>
                                            <?php $__currentLoopData = $manufacturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$manufacturer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($manufacturer->seller_phone); ?></td>
                                                    <td style="width: 20%;"><?php echo e($manufacturer->seller_address); ?></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo203/webapps/demo203/supportstock/resources/views/admin/manufacturers/index.blade.php ENDPATH**/ ?>