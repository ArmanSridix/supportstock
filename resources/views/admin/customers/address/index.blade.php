                                            ...
                                            @foreach($data['customer_addresses'] as $customer_addresses)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <strong>{{ trans('labels.Postcode') }}:</strong> {{ $customer_addresses->pincodes_val }}<br>
                                                        <strong>{{ trans('labels.City') }}:</strong> {{ $customer_addresses->cities_name }}<br>
                                            ...
                                            <div class="col-sm-10 col-md-8">
                                                <select id="entry_city" class="form-control field-validate" name="entry_city">
                                                    ...
                                                    @foreach($data['cities'] as $city_data)
                                                        <option value="{{ $city_data->cities_id }}">{{ $city_data->cities_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
