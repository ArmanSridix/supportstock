                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('seller_phone',  $editManufacturer->seller_phone, array('class'=>'form-control  number-validate', 'id'=>'seller_phone'), value(old('seller_phone'))) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <textarea id="seller_address" name="seller_address" class="form-control  field-validate" rows="4" cols="50">{{$editManufacturer->seller_address}}</textarea>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 col-md-9">
                                                    <select class="form-control field-validate" name="seller_city_id" onChange="selectSellerPincode(this.value);">
                                                      ...
                                                      <option value="{{ $cities->cities_id }}" <?php echo $editManufacturer->seller_city_id==$cities->cities_id?'selected':''; ?> >{{ $cities->cities_name }}</option>
                                                      @endforeach
                                                    </select>
    ...
    <script type="text/javascript">
            ...
            <?php if(isset($result['manufacturureEdit'])){ ?>
              ...
              if (cities_id!='') {
                $("#loader").show();
                  ...
                  $.ajax({
                    type:'POST',
                    url:'{{ url('admin/manufacturers/pincodeByCityEdit') }}',
        ...
        function selectSellerPincode(cities_id){
            ...
            if (cities_id!='') {
              ...
              $.ajax({
                type:'POST',
                url:'{{ url('admin/manufacturers/pincodeByCity') }}',
