                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/updateInvoiceLogo', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        
                                        {!! Form::hidden('oldIcon', $logoDetails[0]->invoice_logo_image , array('id'=>'oldIcon')) !!}
