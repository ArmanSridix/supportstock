...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.pincode') }} <small>{{ trans('labels.AddNewPincode') }}...</small> </h1>
            <ol class="breadcrumb">
                      ...
                      <div class="box-header">
                        ...
                        @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/pincode/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.pincode') }}<span style="color:red;">*</span>

                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('pincodes_val',  '', array('class'=>'form-control field-validate', 'id'=>'pincodes_val'))!!}
