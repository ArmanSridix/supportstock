                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/updateCancelReturn', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-8">
                                              <textarea id="editor1" name="cms_text" class="form-control"
                                                rows="5">{{stripslashes($cancelDetails->cms_text)}}</textarea>
