                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-6">
                                            {!! Form::text('contact_us_phone',  $contactDetails->contact_us_phone, array('class'=>'form-control phone-validate field-validate', 'id'=>'contact_us_phone')) !!}
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-6">
                                             {!! Form::text('contact_email',  $contactDetails->contact_email, array('class'=>'form-control email-validate', 'id'=>'contact_email')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-6">
                                                {!! Form::textarea('contact_address',  $contactDetails->contact_address, array('class'=>'form-control field-validate', 'rows'=>'5', 'id'=>'contact_address'))!!}
