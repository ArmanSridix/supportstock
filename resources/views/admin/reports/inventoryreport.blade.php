                ...
                <div class="col-xs-3">
                  <div class="form-group">
                    ...
                    <select type="button" required class="btn btn-default select2 form-control" data-toggle="dropdown" name="products_id" id="products_id"  >
                        ...
                        <option value="{{$product->products_id}}"  @if( app('request')->input('products_id')) @if  (app('request')->input('products_id') == $product->products_id) {{ 'selected' }} @endif @endif>{{$product->products_name}} ( {{ $product->products_sku }} )</option>
                        @endforeach
                    </select>
                  </div>
                </div>
