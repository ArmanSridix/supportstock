        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="form-inline">
              ...
              <form  name='registration' id="registration" class="" method="get">
                  ...
                  <div class="input-group-form search-panel ">
                      <select id="parameter" type="button" class="btn btn-default dropdown-toggle form-control input-group-form " data-toggle="dropdown" name="bannerType">
                          ...
                          <option value="banner3" @if(request()->get('bannerType') == 'banner3') selected @endif>Banner Style 1</option>
                          ...
                          <option value="banner9" @if(request()->get('bannerType') == 'banner9') selected @endif>Banner Style 2</option>
                          <option value="singlebanner" @if(request()->get('bannerType') == 'singlebanner') selected @endif>Banner Style 3</option>
              ...
              @elseif(request()->get('bannerType')  == 'singlebanner')
                <br>
                <img src="{{asset('images\prototypes\singleBanner.jpg')}}" alt=""  width=100%>
              @endif
          </div>
