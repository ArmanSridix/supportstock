                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateconstantBanner', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group hidden">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="type">
                                          ...
                                          <option value="83" @if($result['banners'][0]->type==83) selected @endif>Banner Style 3</option>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="navigate_type" id="bannerType">
                                          <option value="category" @if($result['banners'][0]->navigate_type=='category') selected @endif>
                                          {{ trans('labels.Category') }}</option>
                                          <option value="product" @if($result['banners'][0]->navigate_type=='product') selected @endif>{{ trans('labels.Product') }}</option>
                                          {{--<option value="topseller" @if($result['banners'][0]->navigate_type=='topseller') selected @endif>{{ trans('labels.TopSeller') }}</option>
                                          <option value="special" @if($result['banners'][0]->navigate_type=='special') selected @endif>{{ trans('labels.Deals') }}</option>
                                          <option value="mostliked" @if($result['banners'][0]->navigate_type=='mostliked') selected @endif>{{ trans('labels.MostLiked') }}</option>--}}
                                      </select>
                                       <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group categoryContent" @if($result['banners'][0]->navigate_type!='category') style="display: none" @endif >
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Categories') }}</label>
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control field-validate category-type select2" name="categories_id" id="categories_id">
                                      @foreach($result['categories'] as $category)
                                    <option value="{{ $category->id}}" <?php if($result['banners'][0]->navigate_type=='category'){if($result['banners'][0]->banners_url==$category->id){echo "selected";}} ?> >{{ $category->name}}</option>
                                      @endforeach
                                      </select>
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group productContent" @if($result['banners'][0]->navigate_type!='product') style="display: none" @endif>
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Products') }}</label>
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control field-validate product-type select2" name="products_id" id="products_id" style="width:100%">
                                      @foreach($result['products'] as $products_data)
                                    <option value="{{ $products_data->products_id }}" <?php if($result['banners'][0]->navigate_type=='product'){if($result['banners'][0]->banners_url==$products_data->products_id){echo "selected";}} ?> >{{ $products_data->products_name. '(' . $products_data->products_sku . ')' }}</option>
                                      @endforeach
                                      </select>
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
