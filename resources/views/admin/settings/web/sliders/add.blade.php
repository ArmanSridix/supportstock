                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <select class="form-control field-validate" name="carousel_id">
                                           <option value="1">@lang('labels.Full Screen Slider (1263x363)')</option>
                                ...
                                <div class="form-group productContent" style="display: none">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      ...
                                      @foreach($result['products'] as $products_data)
                                		    <option value="{{ $products_data->products_id }}">{{ $products_data->products_name. '(' . $products_data->products_sku . ')' }}</option>
                                      @endforeach
                                      </select>
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
