                    ...
                    <div class="box-body">
                                        ...
                                        <div class="row" id="todayDealDiv" style="display: none;">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('deal_start_date',  '', array('class'=>'form-control datepicker', 'id'=>'deal_start_date', 'readonly'=>'readonly'))!!}
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('deal_end_date',  '', array('class'=>'form-control datepicker', 'id'=>'deal_end_date', 'readonly'=>'readonly'))!!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-5">
                                                    {!! Form::text('mrp_price', '', array('class'=>'form-control number-validate', 'id'=>'mrp_price')) !!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                        ...
                        <div class="col-xs-12 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ProductsPrice') }}<span style="color:red;">*</span></label>
                                <div class="col-sm-10 col-md-8">
                                    {!! Form::text('corporate_products_price', '', array('class'=>'form-control number-validate', 'id'=>'corporate_products_price')) !!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        {{ trans('labels.ProductPriceText') }}
                                    </span>
                                    <span class="help-block hidden">{{ trans('labels.ProductPriceText') }}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_sku', $sku, array('class'=>'form-control field-validate', 'id'=>'products_sku', 'readonly'=>'readonly')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane @if($key==0) active @endif" id="product_<?=$languages->languages_id?>">
                                                            <div class="">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Quick Overview<span style="color:red;">*</span> {{--({{ $languages->name }})--}}</label>
                                                                    <div class="col-sm-10 col-md-8">
