                                ...
                                <form  name='registration' id="registration2" class="registration" method="get">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        <select id="FilterBy" type="button" class="btn btn-default dropdown-toggle form-control input-group-form " data-toggle="dropdown" name="categories_id">
                                            ...
                                            <option value="" selected disabled hidden>{{trans('labels.ChooseCategory')}}/{{trans('labels.sku')}}</option>
                                            <option value="Active"
                                                @if(isset($_REQUEST['categories_id']) and !empty($_REQUEST['categories_id']))
                                                    @if( $_REQUEST['categories_id'] == 'Active')
                                                        selected
                                                    @endif
                                                @endif
                                            >Active</option>
                                            <option value="Inactive"
                                                @if(isset($_REQUEST['categories_id']) and !empty($_REQUEST['categories_id']))
                                                    @if( $_REQUEST['categories_id'] == 'Inactive')
                                                        selected
                                                    @endif
                                                @endif
                                            >Inactive</option>
                                        ...
                                        @if(isset($categories_id))  <a class="btn btn-danger " href="{{url('admin/products/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                    </div>
                                </form>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6 text-right">
                                    ...
                                    {{ $results['products']->appends(\Request::except('type'))->render() }}
                                </div>
                              </div>
                        </div>
                        <!-- /.box-body -->
