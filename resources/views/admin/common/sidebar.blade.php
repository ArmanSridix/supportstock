<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      ?>
        <li class="treeview {{ Request::is('admin/editAssuredLogo') ? 'active' : '' }}">
          <a  href="{{ URL::to('admin/editAssuredLogo')}}"><i class="fa fa-picture-o" aria-hidden="true"></i> <span>Assured Logo</span>
          </a>
        </li>

        <li class="treeview {{ Request::is('admin/invoiceLogo') ? 'active' : '' }}">
          <a  href="{{ URL::to('admin/invoiceLogo')}}"><i class="fa fa-picture-o" aria-hidden="true"></i> <span>Invoice Logo</span>
          </a>
        </li>
      <?php } ?>
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/instafeed') ? 'active' : '' }} {{ Request::is('admin/newsletter') ? 'active' : '' }} {{ Request::is('admin/menus') ? 'active' : '' }} {{ Request::is('admin/mailchimp') ? 'active' : '' }} {{ Request::is('admin/topoffer/display') ? 'active' : '' }} {{ Request::is('admin/webPagesSettings/*') ? 'active' : '' }} {{ Request::is('admin/homebanners') ? 'active' : '' }} {{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/addsliderimage') ? 'active' : '' }} {{ Request::is('admin/editslide/*') ? 'active' : '' }} {{ Request::is('admin/webpages') ? 'active' : '' }}  {{ Request::is('admin/addwebpage') ? 'active' : '' }}  {{ Request::is('admin/editwebpage/*') ? 'active' : '' }} {{ Request::is('admin/websettings') ? 'active' : '' }} {{ Request::is('admin/webthemes') ? 'active' : '' }} {{ Request::is('admin/customstyle') ? 'active' : '' }} {{ Request::is('admin/constantbanners') ? 'active' : '' }} {{ Request::is('admin/addconstantbanner') ? 'active' : '' }} {{ Request::is('admin/editconstantbanner/*') ? 'active' : '' }}{{ Request::is('admin/frontCategory') ? 'active' : '' }}{{ Request::is('admin/frontProductCategory') ? 'active' : '' }}" >
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/frontCategory') ? 'active' : '' }}"><a href="{{ URL::to('admin/frontCategory')}}"><i class="fa fa-circle-o"></i> Category </a></li>

            <li class="{{ Request::is('admin/frontProductCategory') ? 'active' : '' }}"><a href="{{ URL::to('admin/frontProductCategory')}}"><i class="fa fa-circle-o"></i> Product Category</a></li>
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/city/display') ? 'active' : '' }} {{ Request::is('admin/city/add') ? 'active' : '' }} {{ Request::is('admin/city/edit/*') ? 'active' : '' }} ">
          <a href="{{ URL::to('admin/city/display')}}">
            <i class="fa fa-map-pin" aria-hidden="true"></i> <span> {{ trans('labels.cityMaster') }} </span>
          </a>
        </li>
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/pincode/display') ? 'active' : '' }} {{ Request::is('admin/pincode/add') ? 'active' : '' }} {{ Request::is('admin/pincode/edit/*') ? 'active' : '' }} ">
          <a href="{{ URL::to('admin/pincode/display')}}">
            <i class="fa fa-map-pin" aria-hidden="true"></i> <span> {{ trans('labels.pincodeMaster') }} </span>
          </a>
        </li>
      ...
      ?>
        <li class="treeview {{ Request::is('admin/corporateRequest/display') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/corporateRequest/display')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.corporateRequest') }}</span>
          </a>
        </li>
      <?php } ?>
      ...
      ?>
        <li class="treeview {{ Request::is('admin/orderstatus') ? 'active' : '' }} {{ Request::is('admin/addorderstatus') ? 'active' : '' }} {{ Request::is('admin/editorderstatus/*') ? 'active' : '' }} {{ Request::is('admin/orders/display') ? 'active' : '' }} {{ Request::is('admin/orders/vieworder/*') ? 'active' : '' }} {{ Request::is('admin/orders/reasonOfCancelOrder') ? 'active' : '' }} {{ Request::is('admin/orders/addReasonOfCancelOrder') ? 'active' : '' }} {{ Request::is('admin/orders/editReasonOfCancelOrder/*') ? 'active' : '' }} {{ Request::is('admin/orders/reasonOfReturnOrder') ? 'active' : '' }} {{ Request::is('admin/orders/addReasonOfReturnOrder') ? 'active' : '' }} {{ Request::is('admin/orders/editReasonOfReturnOrder/*') ? 'active' : '' }} ">
          ...
          <li class="{{ Request::is('admin/orderstatus') ? 'active' : '' }} {{ Request::is('admin/addorderstatus') ? 'active' : '' }} {{ Request::is('admin/editorderstatus/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/orderstatus')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_order_status') }}</a></li>
            ...
            <li class="{{ Request::is('admin/orders/reasonOfCancelOrder') ? 'active' : '' }} {{ Request::is('admin/orders/addReasonOfCancelOrder') ? 'active' : '' }} {{ Request::is('admin/orders/editReasonOfCancelOrder/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/orders/reasonOfCancelOrder')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.reasonOfCancel') }}</a></li>
            <li class="{{ Request::is('admin/orders/reasonOfReturnOrder') ? 'active' : '' }} {{ Request::is('admin/orders/addReasonOfReturnOrder') ? 'active' : '' }} {{ Request::is('admin/orders/editReasonOfReturnOrder/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/orders/reasonOfReturnOrder')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.reasonOfReturn') }}</a></li>
          </ul>
        </li>
      <?php } ?>
      <?php
          ...
          ?>
        <li class="treeview {{ Request::is('admin/outofstock') ? 'active' : '' }}  {{ Request::is('admin/statsproductsliked') ? 'active' : '' }} {{ Request::is('admin/lowinstock') ? 'active' : '' }} {{ Request::is('admin/inventoryreport') ? 'active' : '' }} {{ Request::is('admin/customers-orders-report') ? 'active' : '' }} {{ Request::is('admin/couponreport') ? 'active' : '' }} {{ Request::is('admin/salesreport') ? 'active' : '' }}">
          <a href="#">
  ...
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
           ...
           <li class="{{ Request::is('admin/stockin') ? 'active' : '' }} "><a href="{{ URL::to('admin/stockin')}}"><i class="fa fa-circle-o"></i> Stock in Products</a></li>
      ...
      <?php
        ...
        ?>
        <li class="treeview {{ Request::is('admin/coupons/display') ? 'active' : '' }} {{ Request::is('admin/coupons/add') ? 'active' : '' }} {{ Request::is('admin/editcoupons/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/coupons/display')}}" ><i class="fa fa-tablet" aria-hidden="true"></i> <span>{{ trans('labels.link_coupons') }}</span></a>
        </li>

        <li class="treeview {{ Request::is('admin/coupons/newUserCoupon') ? 'active' : '' }} ">
          <a href="{{ URL::to('admin/coupons/newUserCoupon')}}" ><i class="fa fa-tablet" aria-hidden="true"></i> <span>New User Coupon</span></a>
        </li>
      <?php } ?>
      <?php
...
<span>{{ trans('labels.link_notifications') }}</span> <i class="fa fa-angle-left pull-right"></i>
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/loginsetting') ? 'active' : '' }} {{ Request::is('admin/firebase') ? 'active' : '' }} {{ Request::is('admin/facebooksettings') ? 'active' : '' }} {{ Request::is('admin/setting') ? 'active' : '' }} {{ Request::is('admin/googlesettings') ? 'active' : '' }}  {{ Request::is('admin/alertsetting') ? 'active' : '' }} {{ Request::is('admin/shareThis') ? 'active' : '' }} {{ Request::is('admin/socialLink') ? 'active' : '' }} ">  
        <a href="#">
            <i class="fa fa-gears" aria-hidden="true"></i>
  <span> {{ trans('labels.link_general_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          {{--<li class="{{ Request::is('admin/setting') ? 'active' : '' }}"><a href="{{ URL::to('admin/setting')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_store_setting') }}</a></li>--}}
            ...
            <li class="{{ Request::is('admin/shareThis') ? 'active' : '' }}"><a href="{{ URL::to('admin/shareThis')}}"><i class="fa fa-circle-o"></i> Share This</a></li>

            <li class="{{ Request::is('admin/socialLink') ? 'active' : '' }}"><a href="{{ URL::to('admin/socialLink')}}"><i class="fa fa-circle-o"></i> Social Links</a></li>
  ...
  <span> {{ trans('labels.Manage Admins') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        ?>
           ...
           <li class="treeview {{ Request::is('admin/editContactUs') ? 'active' : '' }} {{ Request::is('admin/editAboutUs') ? 'active' : '' }} {{ Request::is('admin/editTermsAndConditions') ? 'active' : '' }} {{ Request::is('admin/editPrivacyPolicy') ? 'active' : '' }} {{ Request::is('admin/displayFaq') ? 'active' : '' }} {{ Request::is('admin/addFaq') ? 'active' : '' }} {{ Request::is('admin/editFaq/*') ? 'active' : '' }} {{ Request::is('admin/editSellerBenefits') ? 'active' : '' }} {{ Request::is('admin/editCorporateLoginBenefits') ? 'active' : '' }} {{ Request::is('admin/editPayment') ? 'active' : '' }} {{ Request::is('admin/editShipping') ? 'active' : '' }} {{ Request::is('admin/editCancelReturn') ? 'active' : '' }} {{ Request::is('admin/editRefunds') ? 'active' : '' }} {{ Request::is('admin/editReturnPolicy') ? 'active' : '' }} {{ Request::is('admin/editSecurity') ? 'active' : '' }} {{ Request::is('admin/editCustomerService') ? 'active' : '' }} {{ Request::is('admin/editCopyright') ? 'active' : '' }}">
            <a href="#">
              <i class="fa fa-users" aria-hidden="true"></i>
            ...
            <ul class="treeview-menu">
              <li class="{{ Request::is('admin/editContactUs') ? 'active' : '' }}"><a href="{{ URL::to('admin/editContactUs')}}"><i class="fa fa-circle-o"></i> Contact Us</a></li>

              <li class="{{ Request::is('admin/editAboutUs') ? 'active' : '' }}"><a href="{{ URL::to('admin/editAboutUs')}}"><i class="fa fa-circle-o"></i> About Us</a></li>

              <li class="{{ Request::is('admin/editSellerBenefits') ? 'active' : '' }}"><a href="{{ URL::to('admin/editSellerBenefits')}}"><i class="fa fa-circle-o"></i> Seller Benefit's</a></li>

              <li class="{{ Request::is('admin/editCorporateLoginBenefits') ? 'active' : '' }}"><a href="{{ URL::to('admin/editCorporateLoginBenefits')}}"><i class="fa fa-circle-o"></i> Corporate Login Benefit's</a></li>

              <li class="{{ Request::is('admin/editTermsAndConditions') ? 'active' : '' }}"><a href="{{ URL::to('admin/editTermsAndConditions')}}"><i class="fa fa-circle-o"></i> Terms & Conditions</a></li>

              <li class="{{ Request::is('admin/editPrivacyPolicy') ? 'active' : '' }}"><a href="{{ URL::to('admin/editPrivacyPolicy')}}"><i class="fa fa-circle-o"></i> Privacy Policy</a></li>

              <li class="{{ Request::is('admin/displayFaq') ? 'active' : '' }} {{ Request::is('admin/addFaq') ? 'active' : '' }} {{ Request::is('admin/editFaq/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/displayFaq')}}"><i class="fa fa-circle-o"></i> Faq</a></li>

              <li class="{{ Request::is('admin/editPayment') ? 'active' : '' }}"><a href="{{ URL::to('admin/editPayment')}}"><i class="fa fa-circle-o"></i> Payment</a></li>

              <li class="{{ Request::is('admin/editShipping') ? 'active' : '' }}"><a href="{{ URL::to('admin/editShipping')}}"><i class="fa fa-circle-o"></i> Shipping</a></li>

              <li class="{{ Request::is('admin/editCancelReturn') ? 'active' : '' }}"><a href="{{ URL::to('admin/editCancelReturn')}}"><i class="fa fa-circle-o"></i> Cancellation & Returns</a></li>

              <li class="{{ Request::is('admin/editRefunds') ? 'active' : '' }}"><a href="{{ URL::to('admin/editRefunds')}}"><i class="fa fa-circle-o"></i> Refunds</a></li>

              <li class="{{ Request::is('admin/editReturnPolicy') ? 'active' : '' }}"><a href="{{ URL::to('admin/editReturnPolicy')}}"><i class="fa fa-circle-o"></i> Return Policy</a></li>

              <li class="{{ Request::is('admin/editSecurity') ? 'active' : '' }}"><a href="{{ URL::to('admin/editSecurity')}}"><i class="fa fa-circle-o"></i> Security</a></li>

              <li class="{{ Request::is('admin/editCustomerService') ? 'active' : '' }}"><a href="{{ URL::to('admin/editCustomerService')}}"><i class="fa fa-circle-o"></i> Customer Service</a></li>

              <li class="{{ Request::is('admin/editCopyright') ? 'active' : '' }}"><a href="{{ URL::to('admin/editCopyright')}}"><i class="fa fa-circle-o"></i> Copyright</a></li>
            </ul>
          </li>
          <?php 
          }
          ...
          ?>
            <li class="treeview {{ Request::is('admin/paymentmethods/cashOnDelivery') ? 'active' : '' }} {{ Request::is('admin/paymentmethods/display/*') ? 'active' : '' }}">
              <a  href="{{ URL::to('admin/paymentmethods/cashOnDelivery')}}"><i class="fa fa-money" aria-hidden="true"></i> <span>Cash On Delivery</span>
              </a>
            </li>
          <?php } ?>
          ...
          ?>
            <li class="treeview {{ Request::is('admin/contactComment') ? 'active' : '' }}">
              <a  href="{{ URL::to('admin/contactComment')}}"><i class="fa fa-money" aria-hidden="true"></i> <span>Contact Us Comments</span>
              </a>
            </li>
          <?php } ?>
          ...
          ?>
            <li class="treeview {{ Request::is('admin/productEnquiry') ? 'active' : '' }}">
              <a  href="{{ URL::to('admin/productEnquiry')}}"><i class="fa fa-file-text-o" aria-hidden="true"></i> <span>Product Enquiry</span>
              </a>
            </li>
          <?php } ?>
          ...
          ?>
            <li class="treeview {{ Request::is('admin/sellOnSupportStock') ? 'active' : '' }}">
              <a  href="{{ URL::to('admin/sellOnSupportStock')}}"><i class="fa fa-file-text-o" aria-hidden="true"></i> <span>Sell on supportstock</span>
              </a>
            </li>
          <?php } ?>
