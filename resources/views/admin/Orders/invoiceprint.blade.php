        ...
        <div class="col-xs-12">
          <div style="width: 100%;text-align: center;">
            <?php if(!empty($logoDetails)){ ?>
              <img src="{{asset($logoDetails[0]->iconpath)}}" alt="logo" style="width: 100%;" >
            <?php } ?>
          </div>
        </div>
      </div>
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            {{ $data['orders_data'][0]->customers_suburb }} <br>
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            {{ $data['orders_data'][0]->delivery_suburb }} <br>
        ...
        <div class="col-sm-4 invoice-col">
         {{ trans('labels.BillingInfo') }} 
          <address>
            ...
            {{ $data['orders_data'][0]->billing_suburb }} <br>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
                ...
                <td>
                  @if($products->cancel_return_status==1)
                    <span class="label label-danger">Cancel</span>
                  @endif

                  @if($products->cancel_return_status==2)
                ...
                <td>@if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $ttlPr }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</td>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="col-lg-4 col-md-4">
                You save ₹{{ $fnlTtlPrc - ($data['orders_data'][0]->order_price + $data['orders_data'][0]->coupon_amount - $data['orders_data'][0]->shipping_cost - $data['orders_data'][0]->total_tax - $data['orders_data'][0]->cancelReturnPrice) }}
            </div>
          </div>
        </div>
        <br>
          ...
          <div class="table-responsive ">
            <table class="table order-table">
              <tr>
                ...
                <td>
                  @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $data['subtotal'] - $data['orders_data'][0]->cancelReturnPrice }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif
                  </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $data['orders_data'][0]->order_price - $data['orders_data'][0]->cancelReturnPrice }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</td>
                  </td>
              </tr>
            </table>
          </div>
...
function setInvoiceName() {
    var orderID = "{{ $data['orders_data'][0]->orders_id }}"; // Get order ID from Blade template
