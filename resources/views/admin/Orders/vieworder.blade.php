...
<div class="content-wrapper">
  ...
  <section class="invoice" style="margin: 15px;">
      ...
      <div class="row">
        ...
        {!! Form::open(array('url' =>'admin/orders/updateCoustomerNotes', 'method'=>'post', 'class' => 'form-horizontal',)) !!}
        {!! Form::hidden('orders_id', $data['orders_data'][0]->orders_id, array('class'=>'form-control', 'id'=>'orders_id'))!!}
            <div class="col-xs-12">
              <hr>
                <p class="lead">{{ trans('labels.CoustomerNotes') }}:</p>
                  <div class="col-md-12">
                    <div class="form-group">
                      {!! Form::textarea('coustomer_notes', stripslashes($data['orders_data'][0]->coustomer_notes), array('class'=>'form-control', 'id'=>'coustomer_notes', 'rows'=>'4'))!!}
...
<script type="text/javascript">
  $(document).ready(function(){
    CKEDITOR.replace('coustomer_notes');
  });
</script>
