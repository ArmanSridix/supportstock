...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.addreasonOfReturn') }} <small>{{ trans('labels.addreasonOfReturn') }}...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/orders/reasonOfReturnOrder')}}"><i class="fa fa-dashboard"></i>{{ trans('labels.reasonOfReturn') }}</a></li>
                <li class="active">{{ trans('labels.addreasonOfReturn') }}</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.addreasonOfReturn') }}</h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/orders/insertReasonOfReturnOrder', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
