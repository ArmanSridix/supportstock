...
@section('content')
    ...
    @if (count($result['cartList']) > 0)
        ...
        @foreach ($result['cartList'] as $cart_products)
            <?php
    ...
    @if (session()->has('outStockMessage'))
        <div class="alert alert-danger" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
            {{ session()->get('outStockMessage') }}
        </div>
    @endif
                                        ...
                                        <div class="collapse show" id="edit-number" style="">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <form class="" method="post" action="{{ url('addAddress') }}">
                                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    $timeCounter = 1;
                                                    ?>
                                                    @if (count($result['slot_list']) > 0)
                                                        @foreach ($result['slot_list'] as $key => $slot_list)
                                                            <?php
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group return-departure-dts"
                                                        ...
                                                        <form method="POST" action="{{ url('cashOnDeliveryOrder') }}"
                                                  ...
                                                  <input type="hidden" name="coupon_discount" id="cod_coupon_discount"> -->
                                                    ...
                                                    <div class="form-group return-departure-dts" data-method="razor_pay"
                                                        ...
                                                        <form method="POST" action="{{ url('onlineOrderPayment') }}"
                                                            id="onlineOrderForm">
                                                            @csrf
                                                            <input type="hidden" name="pincode_val"
                                                ...
                                                <input type="hidden" name="coupon_discount" id="bank_coupon_discount"> -->
                                                    ...
                                                    <input type="hidden" name="finalOrderTotal" id="finalOrderTotal"
                                                        value="{{ $withDiscTotal - $coupon_discount + $shipping_price + number_format((float) $totalTax, 2, '.', '') }}">
                            ...
                            <div class="card-body">
                                ...
                                <table class="checkout__totals">
                                    ...
                                    @if (count($result['cartList']) > 0)
                                        <tbody class="checkout__totals-products">
                                            ...
                                            @foreach ($result['cartList'] as $cart_products)
                                                <tr>
                                                    <td>
                                                        {{ $cart_products->products_name }} ×
                                                        {{ $cart_products->customers_basket_quantity }}
                                                        <?php
                                                        // if ($cart_products->prodDiscount!='') {
                                    ...
                                    <td>₹{{$finalProdDiscount}}</td>
                                        ...
                                        <tfoot class="checkout__totals-footer">
                                            <tr>
                                                <th>Total</th>
                                                <td>₹{{ $withDiscTotal - $coupon_discount + $shipping_price + number_format((float) $totalTax, 2, '.', '') }}
                                                </td>
                                            </tr>
                                        </tfoot>
                                    @endif
                                ...
                                <!-- <div class="checkout__agree form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="checkout-terms">I have read and agree to the website <a target="_blank" href="{{ URL::to('/termAndCondition') }}">terms and conditions</a>*</label>
                                            </div>
                                        </div>
