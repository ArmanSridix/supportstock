					...
					<div class="col-lg-3 col-md-4">
						<div class="left-side-tabs">
							<div class="dashboard-left-links">
								...
								<a href="{{ URL::to('/myAddress')}}" class="user-item active"><i class="fa fa-map-marker"></i>My Address</a>
											...
											<div class="address-body">
												...
												{{-- <div class="address-item">
													...
													<div class="address-dt-all">
														<h4>Home</h4>
														<p>#34/10,Mahadevan Street, West Mambalam, Chennai, 600015, Tamil Nadu  | +91 98485 85743</p>
														<ul class="action-btns">
															<li><a href="#" data-toggle="modal" data-target="#address_model" class="action-btn"><i class="fa fa-pencil"></i></a></li>
															<li><a href="#" class="action-btn"><i class="fa fa-trash"></i></a></li>
														</ul>
													</div>
												</div> --}}
												@foreach($result['userAddressList'] as $Address)
												<div class="address-item">
													<div class="address-icon1">
														<i class="fa fa-home"></i>
													</div>
													<div class="address-dt-all detailed-address-div">
														{{-- <h4>Home</h4> --}}
														<p class="detailed-address-id" hidden>{{$Address->address_book_id}}</p>
														<p class="detailed-address-city-id" hidden>{{$Address->cities_id}}</p>
														<p class="detailed-address">{{$Address->flat_no}}, {{$Address->entry_street_address}}, {{$Address->cities_name}}, {{$Address->pincodes_val}}</p>
														<ul class="action-btns">
															@if($user->default_address_id == $Address->address_book_id)
					...
					<div class="category-model-content modal-content">
						...
						<div class="add-address-form">
							<div class="checout-address-step">
								<div class="row">
									<div class="col-lg-12">
										<form class="" method="post" action="{{url('updateaddress')}}">
											@csrf
