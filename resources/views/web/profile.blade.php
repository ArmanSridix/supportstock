					...
					<div class="col-lg-3 col-md-4">
						<div class="left-side-tabs">
							<div class="dashboard-left-links">
								...
								<a href="{{ URL::to('/profile')}}" class="user-item active"><i class="fa fa-cog"></i>Account Setting</a>
								...
								<div class="row">
									...
									<div class="pdpt-bg">
										...
										<div class="address-body">
											<form class="submit-page" action="{{ url('updateMyProfile') }}" method="POST">
												@csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                      <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="first_name" placeholder="Name *" value="{{$user->first_name}}" required="">
                                                      </div>
                                                    </div>
													...
													<div class="col-12 col-md-6">
														<div class="form-group">
														  ...
														  <input class="form-control" type="text" name="last_name" placeholder="Name *" value="{{$user->last_name}}" required="">
														</div>
													  </div>
