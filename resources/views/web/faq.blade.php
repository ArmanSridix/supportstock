...
<section class="pt-2 pb-2 page-info section-padding border-bottom bg-white">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <a href="{{ URL::to('/')}}"><strong><span class="mdi mdi-home"></span> Home</strong></a>   <span class="mdi mdi-chevron-right"></span><a href="javascript:;"> Faq's </a>
         </div>
      </div>
   </div>
</section>
            ...
            <div class="row">
               <div class="col-lg-12 col-md-12">
                  <div class="card card-body">
                  	...
                  	@if($result['faq_list'] != null)

                     <div class="accordion" id="accordionExample">

                     	@foreach ($result['faq_list'] as  $key=>$faq_list)
                        ...
                        <div class="card mb-0">
                           <div class="card-header" id="headingOne<?php echo $faq_list->faq_id; ?>">
                              <h6 class="mb-0">
                                 ...
                                 <i class="icofont icofont-question-square"></i>{{$faq_list->faq_title}}
                                 </a>
                              </h6>
                           </div>
